...
require("../../assets/images/logo/logo_test.png")

// TODO:Eliminar codigo o centralizar en este documentes(menu.jsx)
...
const Sidebar = (props) => {
  ...
  // TODO: mejorar codigo para recuperar la url dentro del src y ampliar para images externar https
  const logoName = plant.logoName || "logo";
  const logoDarkName = plant.logoName || "logo_dark";

  const logoPlant = require('../../assets/images/logo/' + logoName + '.png');
  const logoDarkPlant = require('../../assets/images/logo/' + logoDarkName + '.png');
      ...
      <div className="sidebar-wrapper">
        ...
        <div className="logo-wrapper">
          <Link to={`${process.env.PUBLIC_URL}/home`}>
            <img className="img-fluid for-light" src={logoPlant} alt={logoPlant} />
            <img className="img-fluid for-dark" src={logoDarkPlant} alt={logoDarkPlant} />
          </Link>
        ...
        <div className="logo-icon-wrapper">
          <Link to={`${process.env.PUBLIC_URL}/home`}><img className="img-fluid" src={require("../../assets/images/logo/logo-icon.png")} alt="" /></Link>
        </div>
