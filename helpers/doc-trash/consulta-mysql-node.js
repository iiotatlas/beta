...
var con = mysql.createConnection({
  host: "servidoriot.ml",
  user: "admin_serveriot",
  password: "123456789",
  database: "admin_serveriot"
});
...
var client = mqtt.connect("mqtt://servidoriot.ml", options);
...
client.on('message', function (topic, message) {
  ...
  if (topic == "values"){
    ...
    var query = "INSERT INTO `admin_serveriot`.`data` (`data_temp1`, `data_temp2`, `data_volts`) VALUES (" + temp1 + ", " + temp2 + ", " + volts + ");";
